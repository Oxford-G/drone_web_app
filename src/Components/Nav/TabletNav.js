  ...
  return (
    <div className={navBarT === true ? 'topNav2Color tabletNav' : navBarT === 'navImgBlack'
      ...
      <nav className={navBarT ? 'topNav2' : 'topNav'}>
        ...
        <ul className={Toggle ? 'slidingNavT' : 'hideNav'}>
          <ul className={navBarT ? 'slidingDivT' : 'hideNav'}>
            <li
              onClick={closeMenu}>
              <a className="navBT" href="#STORE">STORE</a>
            </li>
            <li
              onClick={closeMenu}>
              <a className="navBT" href="#TUTORIALS">TUTORIALS</a>
            </li>
            <li
              onClick={closeMenu}>
              <a className="navBT" href="#BLOG">BLOG</a>
            </li>
            <li
              onClick={closeMenu}>
              <a className="navBT" href="#CONTACT">CONTACT</a>
            </li>
          </ul>
        </ul>
